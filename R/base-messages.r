...
# to this list
base_fs <- list(
  is.character = function(call, env) call %is_not% "a character vector",
  is.numeric = function(call, env) call %is_not% "a numeric or integer vector",
  is.double = function(call, env) call %is_not% "a numeric vector",
  is.integer = function(call, env) call %is_not% "a numeric vector",
